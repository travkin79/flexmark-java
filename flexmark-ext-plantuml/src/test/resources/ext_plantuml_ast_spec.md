...
PlantUML image statement

```````````````````````````````` example PlantUML image: 1
# Heading

Some text ![image](img/test.png)
in a paragraph.
...
.
<h1>Heading</h1>
<p>Some text <img src="img/test.png" alt="image" />
in a paragraph.</p>
<figure>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" contentStyleType="text/css" height="170px" preserveAspectRatio="none" style="width:106px;height:170px;background:#FFFFFF;" version="1.1" viewBox="0 0 106 170" width="106px" zoomAndPan="magnify">
      <defs/>
...
Document[0, 123]
  Heading[0, 9] textOpen:[0, 1, "#"] text:[2, 9, "Heading"]
    Text[2, 9] chars:[2, 9, "Heading"]
  Paragraph[11, 60] isTrailingBlankLine
    Text[11, 21] chars:[11, 21, "Some text "]
    Image[21, 43] textOpen:[21, 23, "!["] text:[23, 28, "image"] textClose:[28, 29, "]"] linkOpen:[29, 30, "("] url:[30, 42, "img/test.png"] pageRef:[30, 42, "img/test.png"] linkClose:[42, 43, ")"]
      Text[23, 28] chars:[23, 28, "image"]
    SoftLineBreak[43, 44]
    Text[44, 59] chars:[44, 59, "in a  … raph."]
  PlantUmlImage[61, 103] textOpen:[61, 63, "!["] text:[63, 79, "plantuml diagram"] textClose:[79, 80, "]"] linkOpen:[80, 81, "("] url:[81, 102, "diagrams/classes.puml"] pageRef:[81, 102, "diagrams/classes.puml"] linkClose:[102, 103, ")"]
    Text[63, 79] chars:[63, 79, "plant … agram"]
  Paragraph[105, 123]
    Text[105, 123] chars:[105, 123, "Anoth … raph."]
````````````````````````````````